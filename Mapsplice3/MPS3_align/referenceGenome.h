#ifndef __REFERENCE_GENOME_H_INCLUDED__
#define __REFERENCE_GENOME_H_INCLUDED__
...
public:
	ReferenceGenome(unsigned int* sa, BYTE* lcp, unsigned int* child, BYTE* verifyChild,
